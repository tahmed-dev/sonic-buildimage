...
$(DOCKER_BASE_BOOKWORM)_DBG_IMAGE_PACKAGES += $(GDB) $(GDBSERVER) $(VIM) $(SSHPASS) $(STRACE)

ifeq ($(INCLUDE_FIPS), y)
$(DOCKER_BASE_BOOKWORM)_DBG_DEPENDS += $(FIPS_OPENSSH_CLIENT) $(FIPS_OPENSSH_SERVER) $(FIPS_OPENSSH_SFTP_SERVER)
else
$(DOCKER_BASE_BOOKWORM)_DBG_IMAGE_PACKAGES += $(OPENSSH)
endif
